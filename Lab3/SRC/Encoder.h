...
/**
 * @brief Initializes the encoder and make the specified channel active.
 *
 * @param pos the channel on the encoder to initialize. Either High or Low
 *
 */
 ...
 * @brief Initializes the encoder and make the specified channel active.
 *
 * @param __chan on the encoder to initialize. Either High or Low
 *
 */
